...
```
D:\desktop\Java\src\oop>javac Methods.java
Methods.java:4: 错误: name 在 Person 中是 private 访问控制
        ming.name = "xiaoming";
            ^
Methods.java:5: 错误: age 在 Person 中是 private 访问控制
        ming.age = 23;
            ^
Methods.java:6: 错误: name 在 Person 中是 private 访问控制
